...
!function (e) {
    ...
    e.languages.jsdoc = e.languages.extend("javadoclike", {
        ...
        example: {
            ...
            lookbehind: !0,
            inside: {code: {pattern: /^(\s*(?:\*\s*)?).+$/m, lookbehind: !0, inside: a, alias: "language-javascript"}}
        }
...
Prism.languages.jsstacktrace = {
    ...
    "stack-frame": {
        ...
        inside: {
            ...
            filename: {pattern: /(\bat\s+|\()(?:[a-zA-Z]:)?[^():]+(?=:)/, lookbehind: !0, alias: "url"},
            function: {
            ...
            punctuation: /[()]/,
            keyword: /\b(?:at|new)\b/,
            alias: {pattern: /\[(?:as\s+)?[_$a-zA-Z\xA0-\uFFFF][$\w\xA0-\uFFFF]*\]/, alias: "variable"},
...
Prism.languages.scheme = {
    ...
    character: {pattern: /#\\(?:[ux][a-fA-F\d]+|[-a-zA-Z]+|\S)/, greedy: !0, alias: "string"},
    ...
    boolean: {pattern: /(^|[\s()])#[ft](?=[()\s]|$)/, lookbehind: !0},
    ...
    e.languages.naniscript = {
        ...
        command: {
            ...
            inside: {
                ...
                "command-params": {pattern: /[\s\S]*\S[\s\S]*/, inside: n}
            }
        },
        "generic-text": {
            pattern: /(^[ \t]*)[^#@>;\s].*/m,
    ...
    n.languages.regex = {
        charset: {
            ...
            inside: {
                ...
                range: {pattern: i, inside: {escape: e, "range-punctuation": {pattern: /-/, alias: "operator"}}},
                "special-escape": a,
        ...
        e && (e.regex.inside = {
            ...
            }, "regex-flags": /[a-z]+$/i, "regex-delimiter": /^\/|\/$/
        })
    })
}(Prism);
...
Prism.languages.stan = {
    ...
    constraint: {
        ...
        lookbehind: !0,
        inside: {
            expression: {pattern: /(=\s*)(?:(?!\s*(?:>$|,\s*\w+\s*=))[\s\S])+/, lookbehind: !0, inside: null},
...
!function (e) {
    var n = {pattern: /(\b\d+)(?:%|[a-z]+)/, lookbehind: !0}, r = {pattern: /(^|[^\w.-])-?\d*\.?\d+/, lookbehind: !0},
        i = {
            comment: {pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/, lookbehind: !0},
